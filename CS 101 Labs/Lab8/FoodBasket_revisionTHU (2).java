public class FoodBasket_revisionTHU {
    ...
    public static void main (String [] args){
        ...
        Food food4 = new Food("Cheesecake", "sugar, cream cheese, eggs", 500, "dessert", 60);
        ...
        Order order3 = new Order(1, food5);
        ...
        */
        u3.addNewOrder(order4);
        u3.addNewOrder(order2);
        u3.addNewOrder(order3);        
        System.out.println(u3.pickOrderByIndex(10));
